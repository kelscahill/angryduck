...
<form class="c-shipping-calculator woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<section class="c-shipping-calculator__form shipping-calculator-form u-spacing--half u-space--top" style="display:none;">
