...
class WC_Wholesale_Payments extends WC_Payment_Gateway {
    ...
    public function process_payment( $order_id ) {
        ...
        if ( ! $invoice_id ) {
             ...
             */
            $invoice_response = Stripe::instance()->create_invoice( $customer_id, $amounts_due );
        ...
        $order->update_meta_data( '_wpay_stripe_invoice_status', WPay::get_invoice_payment_progress_status( $finalized, 'status' ) );
        $order->save_meta_data();
