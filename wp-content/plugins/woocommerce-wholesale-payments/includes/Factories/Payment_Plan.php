...
class Payment_Plan {
    ...
    public static function save( $args = array() ) {
        ...
        if ( is_bool( $args['apply_restrictions'] ) ) {
            if ( true !== $args['apply_restrictions'] ) {
                $args['apply_restrictions'] = 'no';
            } else {
                $args['apply_restrictions'] = 'yes';
            }
        }
        update_post_meta( $post_id, 'apply_restrictions', $args['apply_restrictions'] );
